<x-app-layout>
    ...
    <div class="relative w-full">
        ...
        {{-- Decorative Elements --}}
        <div class="fixed top-20 right-[10%] opacity-20 floating-icon pointer-events-none hidden lg:block">
        ...
        <div class="max-w-5xl mx-auto py-6">
            ...
            <div class="mb-10 animate-fade-in-down">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl lg:text-4xl font-black text-gray-900 tracking-tight">Tambah <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B35] to-red-500">Pegawai</span></h1>
                        <p class="text-gray-500 font-medium">Lengkapi formulir di bawah untuk mendaftarkan staf baru.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card rounded-[2.5rem] overflow-hidden bg-white/60 backdrop-blur-xl border border-white/50 shadow-xl">
                <form action="{{ route('pegawai.store') }}" method="POST" enctype="multipart/form-data" class="p-6 lg:p-10">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div class="lg:col-span-4 space-y-6">
                            <div class="relative group mx-auto w-fit">
                                <div class="w-56 h-56 rounded-[3rem] overflow-hidden ring-4 ring-white shadow-2xl relative bg-white transition-all duration-500 group-hover:shadow-orange-200">
                                    <img id="preview-image" 
                                         src="https://ui-avatars.com/api/?name=Staf+Baru&background=FF6B35&color=fff&size=512&bold=true" 
                                    ...
                                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-end pb-6">
                                        <p class="text-white text-xs font-black uppercase tracking-widest">Pilih Foto</p>
                                    </div>
                                </div>
                            ...
                            <div class="text-center">
                                <h3 class="font-black text-gray-900 text-xl tracking-tight">Foto Profil</h3>
                                <p class="text-gray-400 text-sm font-medium mt-1">Gunakan foto formal staf Anda.</p>
                            </div>

                            {{-- Stats/Info Sidebar --}}
                            <div class="mt-10 p-6 bg-gradient-to-br from-orange-50 to-red-50 rounded-[2rem] border border-orange-100/50">
                                <h4 class="text-xs font-black text-orange-600 uppercase tracking-widest mb-4">Tips Keamanan</h4>
                                <ul class="space-y-3">
                                    <li class="flex gap-3 text-xs text-orange-800 font-bold">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" name="nama" value="{{ old('nama') }}" required placeholder="Contoh: Andi Wijaya"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="jabatan" value="{{ old('jabatan') }}" required placeholder="Staff Kasir"
                                               class="w-full modern-input rounded-2xl py-4 px-6 text-gray-800 font-bold placeholder-gray-400 focus:outline-none">
                                    </div>
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" name="no_hp" value="{{ old('no_hp') }}" required placeholder="812345xxx"
                                                   class="w-full modern-input rounded-2xl py-4 pl-16 pr-6 text-gray-800 font-bold placeholder-gray-400 focus:outline-none">
                                        </div>
                                    </div>
                                    <div class="col-span-2">
                                        ...
                                        <select name="shift_id" class="w-full modern-input rounded-2xl py-4 px-6 text-gray-800 font-bold focus:outline-none appearance-none cursor-pointer">
                                            <option value="">Tidak Ada Shift (Office Hours)</option>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="username" value="{{ old('username') }}" required placeholder="andi.wijaya"
                                               class="w-full modern-input rounded-2xl py-4 px-6 text-gray-800 font-bold placeholder-gray-400 focus:outline-none">
                                    </div>
                                    <div>
                                    ...
                                    <div class="relative">
                                        <label class="block text-sm font-black text-gray-700 mb-2 ml-1">Password</label>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="password" name="password_confirmation" id="password_confirm" required placeholder="••••••••"
                                               class="w-full modern-input rounded-2xl py-4 px-6 text-gray-800 font-bold placeholder-gray-400 focus:outline-none">
    ...
    <script>
        ...
        function closeCropper() {
            ...
            if (cropper) cropper.destroy();
            // JANGAN HAPUS value input file di sini! 
            // Biarkan user submit file asli jika batal crop / crop gagal.
        }
        ...
        document.getElementById('cropButton').addEventListener('click', () => {
            if (cropper) {
                ...
                // 3. (Opsional) Kosongkan input file asli agar server tahu kita pakai hasil crop
